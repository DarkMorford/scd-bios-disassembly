...
sub_1A28:               ; CODE XREF: ROM:00000394j
	move.w (a1)+, d2
	beq.s  @locret_1A36
...
sub_1CFA:               ; CODE XREF: sub_21F4p
	...
	move.l #$66600002, (VDP_CONTROL).l  ; VRAM $A660
	lea    (unk_9C00).l, a1
	jsr    NemDec
	...
	moveq  #$27, d1
	moveq  #$15, d2
	move.l #$53800003, d0               ; VRAM $D380
	lea    (decompScratch).w, a1
	jsr    writeTilemapToVram

	move.l #$50C00003, (VDP_CONTROL).l  ; VRAM $D0C0
	lea    (unk_BAAE).l, a1
	jsr    NemDec
	...
	moveq  #$C, d1
	moveq  #$A, d2
	move.l #$58020003, d0               ; VRAM $D802
	lea    (decompScratch).w, a1
	jsr    writeTilemapToVram

	moveq  #15, d7
	move.l #$61E00003, (VDP_CONTROL).l  ; VRAM $E1E0
	@loc_1DFA:
	...
	moveq  #$27, d1
	moveq  #2, d2
	move.l #$64000003, d0               ; VRAM $E400
	move.w #$670F, d3
	jsr    fillVramTilemap

	moveq  #$27, d1
	moveq  #2, d2
	move.l #$70800003, d0               ; VRAM $F080
	move.w #$670F, d3
	jsr    fillVramTilemap

	moveq  #$27, d1
	moveq  #2, d2
	move.l #$72000003, d0               ; VRAM $F200
	move.w #$670F, d3
	jsr    fillVramTilemap

	moveq  #$27, d1
	moveq  #2, d2
	move.l #$7E800003, d0               ; VRAM $FE80
	move.w #$670F, d3
	jsr    fillVramTilemap

	move.l #$60000003, (VDP_CONTROL).l  ; VRAM $E000
	lea    (word_EB12).l, a0
	move.w #175, d6
	@loc_1E62:
	...
	move.w #$E700, d0
	moveq  #10, d7
	move.l #$53280003, (VDP_CONTROL).l  ; VRAM $D328
	@loc_1E7C:
		move.w d0, (VDP_DATA).l
		addq.w #1, d0
		dbf d7, @loc_1E7C

	move.l #$61600003, (VDP_CONTROL).l  ; VRAM $E160
	lea    (dword_EC72).l, a0
	move.w #31,d7
	@loc_1E9C:
	...
	move.w #$E70B, d0
	moveq  #3, d7
	move.l #$53400003, (VDP_CONTROL).l  ; VRAM $D340
	@loc_1EB6:
		move.w d0, (VDP_DATA).l
		addq.w #1, d0
		dbf d7, @loc_1EB6
	...
	move.l #$53480003, (VDP_CONTROL).l  ; VRAM $D348
	move.w #$E693, d0
	move.w d0, (VDP_DATA).l

	move.l #$534A0003, (VDP_CONTROL).l  ; VRAM $D34A
	move.w #$E693, d0
	move.w d0, (VDP_DATA).l
	...
	move.l #$66020003, d0       ; VRAM $E602
	move.w #$25, d1
	move.w #4,   d2
	move.w #1,   d3
	jsr    sub_199C

	move.l #$68820003, d0       ; VRAM $E882
	move.w #$25, d1
	move.w #4,   d2
	move.w #$BF, d3
	jsr    sub_199C

	move.l #$6B020003, d0       ; VRAM $EB02
	move.w #$25,  d1
	move.w #4,    d2
	move.w #$17D, d3
	jsr    sub_199C

	move.l #$6D820003, d0       ; VRAM $ED82
	move.w #$25,  d1
	move.w #4,    d2
	move.w #$475, d3
	jsr    sub_199C

	move.l #$74020003, d0       ; VRAM $F402
	move.w #$25,  d1
	move.w #4,    d2
	move.w #$23B, d3
	jsr    sub_199C

	move.l #$76820003, d0       ; VRAM $F682
	move.w #$25,  d1
	move.w #4,    d2
	move.w #$2F9, d3
	jsr    sub_199C

	move.l #$79020003, d0       ; VRAM $F902
	move.w #$25,  d1
	move.w #4,    d2
	move.w #$3B7, d3
	jsr    sub_199C

	move.l #$7B820003, d0       ; VRAM $FB82
	move.w #$25,  d1
	move.w #4,    d2
	move.w #$475, d3
	jsr    sub_199C
...
sub_30C2:               ; CODE XREF: sub_3040p
	...
	move.l #$44000002, (VDP_CONTROL).l      ; VRAM $8400
...
sub_68C4:               ; CODE XREF: ROM:00000364j
	...
	move.w #$4EF9,    (vblankUserRoutine).w
