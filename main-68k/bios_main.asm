...
sub_1134:               ; CODE XREF: ROM:0000029Cj sub_118C+6p ...
	...
	; Set TH bit high to read CBRLDU
	move.b  d3,(a6)
	bsr.s   sub_1174

	; Set TH bit low to read SA00DU
	move.b  #0,(a6)
	add.w   d7,d7
	bsr.s   sub_1174
...
; ---------------------------------------------------------------------------
palette_2F8C:        ; DATA XREF: sub_2F58+6o
	dc.w $0EE
	dc.w $0AE
	dc.w $06E
	dc.w $00E
...
loc_31D4:                               ; CODE XREF: sub_319E+3Ej
		btst    #0,(Z80_BUSREQ).l
		bne.s   loc_31D4
		move.w  (sp)+,(a4)
...
sub_68C4:               ; CODE XREF: ROM:00000364j
	...
	move.l #@loc_6A1E, (vblankJumpTarget+2).w
...
sub_6D68:                       ; DATA XREF: ROM:00006B10o
	tst.w  $28(a0)
	beq.s  @loc_6D84
...
loc_957E:				; CODE XREF: sub_9522+58j
		mulu.w	#$80,d1	; '€'
		move.l	$38(a5),d0
		sub.l	d1,d0
		cmp.l	a0,d0
...
loc_9590:				; CODE XREF: sub_9522+4Cj sub_9522+68j
		move.b	0(a6),d0
		move.l	d3,(a6)
		clr.l	$66(a5)
		movem.l	(sp)+,d1/a1
...
loc_95B8:				; CODE XREF: sub_9522+Cj
		exg	a0,a1
		move.l	a1,-(sp)
		move.l	a0,-(sp)
		bsr.w	sub_91DA
...
loc_95E0:				; CODE XREF: sub_9522+D4j
		move.w	d3,d0
		bsr.w	sub_9146
		lea	unk_889A,a1
		bsr.w	sub_92D0
...
loc_960E:				; CODE XREF: sub_9522+102j
		move.w	d3,d0
		bsr.w	sub_90DE
		lea	unk_8888,a1
		bsr.w	sub_92D0
...
loc_963E:				; CODE XREF: sub_9522+136j
		movem.l	(sp)+,d1/a0-a1
		move	sr,-(sp)
		adda.w	d1,a0
		adda.w	d1,a0
...
loc_9654:				; CODE XREF: sub_9522+80j
		move	#1,ccr
		bra.s	loc_963E
...
SubCPU_Prog1:          ; DATA XREF: loadSubCpuPrg+28o
