...
loc_256:				; CODE XREF: BIOS:_startj
		clr.b	(GA_INT_MASK).w
		m_disableInterrupts
...
loc_2E0:				; CODE XREF: BIOS:000002E2j
					; BIOS:000002E6j
...
loc_2F6:				; CODE XREF: BIOS:000002EEj
		movea.l	#$5800,a0
		move.l	#$6000,d1
		subi.l	#$5801,d1
		lsr.l	#4,d1		; d1 = 0x7F
...
loc_30C:				; CODE XREF: BIOS:00000314j
...
loc_326:				; CODE XREF: BIOS:0000032Aj
		move.w	d0,(a1)+
		move.l	a0,(a1)+
		dbf	d1,loc_326
		lea	_reset(pc),a0
...
loc_334:				; CODE XREF: BIOS:00000338j
		move.w	d0,(a1)+
		move.l	a0,(a1)+
		dbf	d1,loc_334
		lea	_nullrte(pc),a0
...
loc_342:				; CODE XREF: BIOS:00000346j
		move.w	d0,(a1)+
		move.l	a0,(a1)+
		dbf	d1,loc_342
		bsr.w	initLEDs
...
loc_45C:				; CODE XREF: installJumpTable+F0j
		...
		bra.s	loc_41C
; ---------------------------------------------------------------------------
asc_46A:	dc.b 'BOOT____SYS'      ; DATA XREF: installJumpTable+100o
		dc.b 0
		dc.b 1
		dc.b 0
		dc.b 0
...
loc_4B0:				; CODE XREF: installJumpTable+150j
		btst	#1,(a0)
		beq.s	loc_4B0

loc_4B6:				; CODE XREF: installJumpTable+156j
		bclr	d0,(a0)
		btst	d0,(a0)
		bne.s	loc_4B6

loc_4BC:				; CODE XREF: installJumpTable+13Ej
					; installJumpTable+14Aj
		movea.l	a1,a0
		lea	(asc_6000).w,a0	; "MAINBOOTUSR"
		moveq	#6,d0
		bsr.w	_CDBOOT
		bcs.s	loc_494

loc_4CA:				; CODE XREF: installJumpTable+174j
		bsr.w	_waitForVBlank
		bsr.w	loc_51E
		moveq	#7,d0
		bsr.w	_CDBOOT
...
loc_4F0:				; CODE XREF: installJumpTable+190j
		bclr	d0,(a0)
		btst	d0,(a0)
		bne.s	loc_4F0
		bra.s	loc_4FE
...
loc_684:				; CODE XREF: updateLEDs+8j
...
loc_6A2:				; CODE XREF: updateLEDs+16j
		btst	#7,ledBitfield(a5)
		beq.s	locret_6BA

loc_6AA:				; CODE XREF: updateLEDs+2Aj
		andi.w	#7,d0
		add.w	d0,d0
		jsr	ledJumpTable(pc,d0.w)
		move.b	ledStatus(a5),(GA_LED_STATUS).w

locret_6BA:				; CODE XREF: updateLEDs+32j
		rts
...
locret_73A:				; CODE XREF: sub_71A+10j sub_71A+1Aj
		rts
...
; ---------------------------------------------------------------------------
unk_22E6:	dc.b $7F ; 		; DATA XREF: sub_23B8+Eo
		dc.b   0
		dc.b   1
		dc.b   6
		dc.b   2
...
loc_2746:				; CODE XREF: initVolume+Aj
		move.l	d0,(a0)+
		dbf	d1,loc_2746
		move.w	d0,(a0)
...
loc_277C:				; CODE XREF: _fdrset+Aj
...
loc_45F6:				; CODE XREF: BIOS:0000459Cj
		...
		bra.s	loc_45D0
; ---------------------------------------------------------------------------
off_460E:	dc.l asc_4616		; DATA XREF: BIOS:000045BAo
					; "NOT_EXIST__"
		dc.b   0
		dc.b   0
		dc.b $46 ; F
		dc.b $22 ; "
asc_4616:	dc.b 'NOT_EXIST__',0    ; DATA XREF: BIOS:off_460Eo
		dc.b $55 ; U
		dc.b $4E ; N
		dc.b $46 ; F
		dc.b $4F ; O
