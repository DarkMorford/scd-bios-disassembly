...
splitBcdByte:                ; CODE XREF: sub_BA0+8p sub_BA0+10p ...
	lsl.w  #4, d0
	lsr.b  #4, d0
	move.w d0, (a1)+
	rts
...
_scdstart:              ; CODE XREF: executeCdbCommand+4Aj
	...
	movea.l scdPcktAddress(a5), a4
	move.w  6(a4), 4(a4)

	movea.l scdPackAddress(a5), a4
	move.w  6(a4), 4(a4)

	movea.l scdQcodAddress(a5), a4
	move.w  6(a4), 4(a4)
